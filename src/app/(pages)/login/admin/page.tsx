...
import Cookie from 'js-cookie'; // Para trabalhar com cookies no frontend
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        Cookie.set('token', token, { expires: 1, path: '/' }); // Armazenando o token por 1 dia
  ...
  return (
    <div className="min-h-screen bg-gray-200 flex items-center justify-center text-black">
      <div className="w-full max-w-sm p-8 bg-white rounded-lg shadow-lg">
        <h2 className="text-2xl font-semibold text-center mb-6">Login de Administrador</h2>
